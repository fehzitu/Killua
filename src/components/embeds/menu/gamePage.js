...
module.exports = function createInteractionPage(user) {
    return (
        createEmbed(user)
            .addFields([{
                name: '**🎮 Menu de jogos**',
                value: '**😝 Ta afim de fazer algumas apostas e lucrar um pouco? E que tal jogar contra outras pessoas?\n\n🎮 Cada valor arrecadado aqui é apenas virtual mas poderá ser trocado por dinheiro real no futuro!**'
            }])
